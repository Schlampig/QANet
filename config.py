...
###################################################################################################################
# home = os.getcwd()
train_file = "/users/Xbc/QANet/chn/QANet/data/备用数据/gen_train.json"
dev_file = "/users/Xbc/QANet/chn/QANet/data/备用数据/gen_dev.json"
test_file = "/users/Xbc/QANet/chn/QANet/data/备用数据/gen_test.json"
gpu_ratio, gpu_id = 0.5, "3"
...
pretrain_word_emb_file = "/users/zhuyujin/datasets/Tencent_AILab_ChineseEmbedding.txt"
pretrain_char_emb_file = "/users/zhuyujin/datasets/Tencent_AILab_ChineseEmbedding.txt"
...
def set_gpu(gpu_ratio=0.3, gpu_id="0"):
...
flags.DEFINE_string("pretrain_word_emb_file", pretrain_word_emb_file, "Input file for word embedding")
...
flags.DEFINE_boolean("use_char_emb", False, "Character dictionary")  # 是否使用字符embedding
...
flags.DEFINE_integer("test_ans_limit", 100, "Limit length for question in test file")

flags.DEFINE_integer("char_dim", 64, "Embedding dimension for char")
flags.DEFINE_integer("vec_size", 200, "Embedding dimension for char")
